    ...
    <q-page-container>
      <q-page padding>
        <div v-if="isUser" class="row relative-position q-mb-sm full-width" style="height:35px;">
          <q-expansion-item switch-toggle-side dense-toggle label="Edit Treaty" class="absolute-right" style="z-index:2">
            <EditTreatyWidget
              :name="treaty.name"
        ...
        <h5 class="q-pl-none q-pt-lg q-pb-sm">Provisions:</h5>
        ...
        :orgBname= "orgBname"
        :userOrganizationId="userOrganizationId" />
        <h5 class="q-pa-none">Votes:</h5>
        <TreatyVotesTable
      :reload="getVotes"
      :key="'votes' + counter"
      :votes="votes"
      :id="treatyId" />
        <h5 class="q-pl-none q-pt-lg q-pb-sm">Comments:</h5>
        <CommentsWidget
              :entityId="treatyId"
              entityType="treaty"
        ></CommentsWidget>
...
export default {
  ...
  props: ['treatyId', 'userOrganizationId', 'creatorName', 'creatorId', 'orgAname', 'orgBname'],
